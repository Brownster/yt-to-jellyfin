...
A Bash script that leverages yt-dlp to download an entire YouTube playlist and then postprocesses each video to work as TV show episodes in Kodi or Jellyfin. This script downloads videos, generates matching NFO metadata files, renames episodes according to your season/episode numbering scheme, creates tv show andseason artwork, converts the videos to H.265 for optimized playback.
Features
