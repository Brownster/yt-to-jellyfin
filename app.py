...
class YTToJellyfin:
    ...
    def _load_config(self) -> Dict:
        ...
        if os.path.exists(local_ytdlp) and os.access(local_ytdlp, os.X_OK):
            ...
            # Look for your specific yt-dlp path
            specific_ytdlp = '/home/marc/Documents/yt-dlp/yt-dlp'
            if os.path.exists(specific_ytdlp) and os.access(specific_ytdlp, os.X_OK):
                ytdlp_default = specific_ytdlp
            else:
